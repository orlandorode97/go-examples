...
const (
	ServiceB_Ping_FullMethodName = "/service_b.ServiceB/Ping"
)
...
func (c *serviceBClient) Ping(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*PingResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PingResponse)
	err := c.cc.Invoke(ctx, ServiceB_Ping_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedServiceBServer) Ping(context.Context, *PingRequest) (*PingResponse, error) {
...
func _ServiceB_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ServiceB_Ping_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServiceBServer).Ping(ctx, req.(*PingRequest))
	}
...
var ServiceB_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "service_b/service.proto",
}
