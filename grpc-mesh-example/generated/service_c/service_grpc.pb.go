...
const (
	ServiceC_Ping_FullMethodName = "/service_c.ServiceC/Ping"
)
...
func (c *serviceCClient) Ping(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*PingResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PingResponse)
	err := c.cc.Invoke(ctx, ServiceC_Ping_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedServiceCServer) Ping(context.Context, *PingRequest) (*PingResponse, error) {
...
func RegisterServiceCServer(s grpc.ServiceRegistrar, srv ServiceCServer) {
	// If the following call panics, it indicates UnimplementedServiceCServer was
...
func _ServiceC_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PingRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ServiceCServer).Ping(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ServiceC_Ping_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServiceCServer).Ping(ctx, req.(*PingRequest))
	}
...
var ServiceC_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "service_c.ServiceC",
	HandlerType: (*ServiceCServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Ping",
			Handler:    _ServiceC_Ping_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "service_c/service.proto",
}
